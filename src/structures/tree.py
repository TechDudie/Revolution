    ...
    def click(self, event):
        if self.location[0] < event.x / 32 < self.location[0] + self.hitbox[0] and self.location[1] < event.y / 32 < self.location[1] + self.hitbox[1]:
            ...
            if self.hp == 0:
                ...
                for i in range(0, 5):
                    map.create("leaves", self.location[0] + 5, self.location[1] + i)
                for i in range(0, 5):
                    map.create("leaves", self.location[0] + 6, self.location[1] + i)
                for i in range(1, 4):
                    map.create("leaves", self.location[0] + 7, self.location[1] + i)
                update()